...
import { getAuthToken } from '@/lib/auth';import { formatNumberWithCommas } from '@/lib/utils/numberFormat';import theme from '@/styles/theme';
...
export default function ProductionPage() {
  ...
  const loadProduction = async () => {
    try {
      ...
      const production = allMovements.filter((m: any) => m.type === 'production');
      setMovements(production);
    } catch (error) {
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p style={{ color: theme.colors.text.secondary }}>
                Complete list of all production batches
              </p>
            </div>
          </div>
        </div>
